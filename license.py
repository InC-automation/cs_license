...
class license:
    ...
    def uc_connect(self):
        ...
        print(f'{self.get_timestring()} UserChannel. Connect ({self.uc_url}) attempt...')
        ...
        try:
            ...
            print(f'{self.get_timestring()} UserChannel. GetAllObjectsData error: {e.code()}, {e.details()}')
            self.uc_close(self.connect_period)
            #return []
        else:
            if self.trace: print(f'{self.get_timestring()} UserChannel. Connect SUCCESS')
    ...
    def gw_connect(self):          
        ...
        print(f'{self.get_timestring()} ApiGateWay. Connect ({self.gw_url}) attempt...')
        ...
        try:
            ...
            print(f'{self.get_timestring()} ApiGateWay. GetCsInfo error: {e.code()}, {e.details()}')
            self.gw_close(self.connect_period)
            #return []
        else:
            if self.trace: print(f'{self.get_timestring()} ApiGateWay. Connect SUCCESS')
    ...
    def uc_close(self, tSleep = 0):
        print(f'{self.get_timestring()} UserChannel. Close connect...')
    ...
    def gw_close(self, tSleep = 0):
        print(f'{self.get_timestring()} ApiGateWay. Close connect...')
    ...
    # финализатор класса
    def __del__(self):
        print(f'{self.get_timestring()} Close all connections (finally)...')
        try:
            self.uc_close.close()
            self.gw_close.close()
        except:
